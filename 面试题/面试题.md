...
功能上来说 ：JDK动态代理的目标类必须实现接口，使用反射生成代理对象，而CGLIB目标类不需要实现接口，但不能用final修饰，因为CGLIB是生成被代理对象的子类。

性能上来说：

早期的jdk动态代理和CGlib动态代理

是他也并不是适用于所有的场景。主要体现在如下的两个指标中：
...
![img](https://pic3.zhimg.com/v2-94c0c139bfa0716222a341394b8106ce_b.jpg)



### 1.Session复制

![img](https://pic4.zhimg.com/v2-d5f57eb4e6b15569ce2fedd08e1232d7_b.jpg)
...
![img](https:////upload-images.jianshu.io/upload_images/22757822-e15f391218e8f095?imageMogr2/auto-orient/strip|imageView2/2/w/854/format/webp)
...
![img](https://pic4.zhimg.com/v2-4c21ce400e4cb53b5b3736b56f58f7f3_b.jpg)
...
![img](https://pic3.zhimg.com/v2-e84022d42c4fdd0286a5f858c293b542_b.jpg)

上面这种方式我们使用 Nginx 四层负载均衡方式，其实 Nginx 还可以做到七层负载均衡方式，也就是使用 Http 协议中的一些**业务属性**来做 Hash，常见的有 *userId*,*loginId*等等。

架构图如下：

![img](https://pic1.zhimg.com/v2-e142179a91c0c394140ab1db9357ca08_b.jpg)
...
![img](https://pic3.zhimg.com/v2-5cd94dd7ed5e6dc612f4fb9f40a81b72_b.jpg)
...
作者：Leon Tian
链接：https://zhuanlan.zhihu.com/p/53438208
来源：知乎
